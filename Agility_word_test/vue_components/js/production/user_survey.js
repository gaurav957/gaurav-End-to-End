...
Vue.component('survey-panel',{
	props:['surveyData','user'],
							...
							<div class="right-imageresponse">\
                               <div class="response-block-txt">\
									...
									<div class="imageresponse-btn">\
								      <div class="switch-btn-custom" :forward-btn="user.forwardBtnTarget" :backward-btn="user.backwardBtnTarget">\
	...
	methods:{
		...
		mounted : function(){
		   ...
		   $(".switching").on("click", function(){
			   ...
			   //console.log($(this).parent().attr("forward-btn"));
			   //console.log($(this).parent().attr("backward-btn"));
				forwardBtn($(this).parent().attr("forward-btn"));
		  ...
		  function swipeHandlerRight( event ){
			...
			function forwardBtn(forwardBtnId){
